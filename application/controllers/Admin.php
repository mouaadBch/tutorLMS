...
class Admin extends CI_Controller
{
    ...
    public function purchase_history($param1 = "")
    {
        ...
        if ($param1 != "") {
            ...
            $page_data['timestamp_start'] = null;
            $page_data['timestamp_end']   = strtotime(date("m/t/Y 23:59:59"));
        }
        /* code mouaad */
    ...
    { // param1 is the status and param2 is the application id
        ...
        if ($param1 == 'approve' || $param1 == 'delete' || $param1 == 'waiting') {
    ...
    function instructor_payment($instructor_id = "", $param2 = "")
    {
        $this->payment_model->configure_instructor_payment($instructor_id);
        if ($param2 == 'offline') {
            redirect(site_url('payment/success_instructor_payment/offline'));
        }
