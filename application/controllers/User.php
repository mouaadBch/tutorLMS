...
class User extends CI_Controller
{
    ...
    public function course_actions($param1 = "", $param2 = "")
    {
        ...
        if ($param1 == "add") {
            ...
            if (max_nbr_courses()) {
                ...
                redirect(site_url('user/course_form/add_course'), 'refresh');
            }
            /* code mouaad */
        } elseif ($param1 == "edit") {
    ...
    function submit_quiz_answer($quiz_id = "", $question_id = "", $question_type = ""){
        ...
        if($results->num_rows() > 0 && ($total_seconds + $results->row('date_added')) > time() || $total_seconds == 0){
            ...
            $data['total_obtained_marks'] = round((intval($total_marks)/$total_questions)*count($correct_answer_question_ids), 1);
