...
class Home extends CI_Controller
{
    ...
    public function get_enrolled_to_free_course($course_id)
    {
        ...
        if ($this->session->userdata('user_login') == 1) {
            if (max_nbr_user()){
                ...
                $this->session->set_flashdata('error_message','Please contact your admin pour enrol in this course');                
            }
    ...
    function course_payment(){
        ...
        if (!max_nbr_user()){
            $this->session->set_flashdata('error_message', "You cannot register for those courses, please contact your administrator to register for those courses");
