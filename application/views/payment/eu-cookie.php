...
<div class="cookieConsentContainer" id="cookieConsentContainer" style="opacity: .9; display: block; display: none;" <?php echo ($this->session->userdata('language') == 'ar') ? "dir='rtl'" : "" ?>>
  ...
  <div class="cookieDesc">
    <p>
      ...
      ?>
      <?php echo site_phrase('cookie_note_text'); ?>
      <!-- /code Mouaad -->
