...
<body>
    <div id="capture" style="position: relative; width: 750px; margin-left: auto; margin-right: auto;">
        ...
        $certificate_template =  str_replace("{certificate_template}", get_settings('certificate_template'), $certificate_template);
        $certificate_template =  str_replace("{website}", $domain, $certificate_template);
