...
<?php elseif ($get_lesson_type == '11google_drive_video_url') : ?>
	<?php
...
<?php elseif ($get_lesson_type == 'vimeo_video_url') : ?>
	...
	<?php include "plyr_config.php"; ?>
<?php elseif ($get_lesson_type == 'bunny_video_url') : ?>
	<div class="p-3 <?php if ($full_page) echo 'bg-black'; ?>">
		<div>
			<iframe height="500" src="<?php echo $lesson_details['video_url']; ?>?autoplay=false&loop=false&muted=false&preload=true" loading="lazy" style="border:0;width:100%;" allow="accelerometer;gyroscope;autoplay;encrypted-media;picture-in-picture;" allowfullscreen="true"></iframe>
		</div>
	</div>
...
<?php elseif  ($get_lesson_type == 'google_drive_video_url') : ?>
	<iframe width="100%" height="500px" src="<?= $lesson_details['video_url'] ?>"></iframe>
<?php else : ?>
	<div class="w-100">
