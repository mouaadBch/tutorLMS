    ...
    <?php foreach($quiz_questions->result_array() as $question_number => $quiz_question):
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                    ...
                    <div class="w-100 text-success fw-bold">
                        ...
                        <?php
                            foreach(json_decode($quiz_question['correct_answers'], true) as $ans_arr_key => $correct_answer):
                                ...
                                echo '<p>'.$ans_arr[$correct_answer].'</p>';
                ...
                <?php endif; ?>
                <!-- code mouaad -->
                <?php if ($quiz_question['justify']) { ?>
                    <div style="border: 2px solid #198754;padding: 8px 9px;">
                        <?php echo  remove_js(htmlspecialchars_decode($quiz_question['justify'])); ?>
                    </div>
                <?php  } ?>
                <!-- code mouaad -->
            </div>
    ...
    <?php elseif($quiz_question['type'] == 'fill_in_the_blank'): ?>
        ...
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                ...
                endforeach; */
                $question_title_correct = $question_title;
                foreach($correct_answers as $i => $correct_answer):
                    if (isset($user_answers[$i]) && ($user_answers[$i] == $correct_answer) ) {
                        $text_remplace = '<strong class="text-success">' . $correct_answer . '</strong>' ;
                    }else{
                        $text_remplace = '<strong class="text-danger">' . $correct_answer . '</strong>' ;
                    }
                    $question_title_correct = str_replace('(_'.($i+1).'_)',$text_remplace, $question_title_correct);
                endforeach;
                echo $question_title_correct ;
                ?>
            </div>
        </div>
        <div class="row justify-content-center">
            ...
            <div class="col-md-9">
                <div class="input-group mb-3">
                    ...
                    <?php foreach($correct_answers as $key => $word): ?>
                        ...
                        <span class="input-group-text" style="background: white;"><?php echo ++$key; ?></span>
