          ...
          <div class="col-md-12 ">
            <div class="profile-ful-body common-card">
              <div>
                ...
                <form class="affiliate_form" action="<?php echo site_url('home/payout_settings'); ?>" method="post" enctype="multipart/form-data"> 
                  <?php $payment_gateways = $this->db->get('payment_gateways')->result_array();
                      ...
                      ?>
                      <div class="<?php if($payment_gateway['identifier'] == 'cmi' || $payment_gateway['status'] != 1 || !addon_status($payment_gateway['identifier']) && $payment_gateway['is_addon'] == 1) echo 'd-none'; ?>">
