    ...
    <div class="offcanves-top">
      ...
      <?php else: ?>
          ...
          <div class="offcanves-btn">
            ...
            <a href="<?php echo site_url('login'); ?>" class="signUp-btn"><?php echo get_phrase('Login'); ?></a>
          </div>
        </div>
      <?php endif; ?>
    </div>
      ...
      <div class="flex-shrink-0 mt-3">
        <ul class="list-unstyled ps-0">
              ...
              <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small bg-white">
                ...
                <li>
                  <button class="btn btn-toggle d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400 collapsed" data-bs-toggle="collapse" data-bs-target="#subCategory-collapse<?php echo $category['id']; ?>" aria-expanded="false">
                    ...
                    <span class="text-cat"><?php echo site_phrase($category['name']); ?></span>
                  </button>
                  <div class="collapse" id="subCategory-collapse<?php echo $category['id']; ?>">
                    <ul class="btn-toggle-nav list-unstyled fw-normal pb-1 small">
                      ...
                      <li>
                        <a class="text-dark text-14px fw-400 w-100" href="<?php echo site_url('home/courses?category='.slugify($sub_category['slug'])) ?>" class="link-body-emphasis d-inline-flex text-decoration-none rounded" style="padding-left: 35px;"><?php echo site_phrase($sub_category['name']); ?></a>
                      </li>
                      <?php endforeach; ?>
                    </ul>
                  </div>
            ...
            <li class="bg-light">
              ...
              <div class="collapse" id="ebook-category-collapse">
                ...
                foreach ($ebook_categories as $key => $ebook_category):?>
                  <li>
                    <a href="<?php echo site_url('ebook?category='.$ebook_category['slug'].'&price=all&rating=all') ?>" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-15px fw-400"> <?php echo site_phrase($ebook_category['title']); ?></a>
                  </li>
                  <?php endforeach; ?>
                  <li>
          ...
          <!-- <?php #if(addon_status('course_bundle')): ?>
            <li class="bg-light">
              <a href="<?php #echo site_url('course_bundles'); ?>" style="border-radius: 20px;background-image: url('https://monconcours.ma/images/giphy.gif');background-size: cover;" class="btn btn-toggle-list d-inline-flex align-items-center rounded border-0 text-dark text-16px fw-500">
                <i class="fas fa-cube me-2"></i> 
                <span class=" text-danger fs-6 fw-bolder bg-white px-1 rounded"><?php #echo get_phrase('Course Bundles'); ?></span>
              </a>
            </li>
          <?php #endif; ?> -->
          ...
          <?php endif; ?>
            ...
            <li class="bg-light">
              <a href="<?php  if ($this->session->userdata('language') == 'fr' || $this->session->userdata('language') == 'french') {
                                  echo site_url('page/new-tutors-fr');
                                } elseif ($this->session->userdata('language') == 'en' || $this->session->userdata('language') == 'english') {
                                  echo site_url('page/new-tutors-en');
                                } elseif ($this->session->userdata('language') == 'ar' || $this->session->userdata('language') == 'arabe') {
                                  echo site_url('page/new-tutors-ar');
                                } elseif ($this->session->userdata('language') == 'sp' || $this->session->userdata('language') == 'spanish') {
