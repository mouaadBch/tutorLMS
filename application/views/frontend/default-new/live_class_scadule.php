...
<?php if(addon_status('jitsi-live-class')):
		...
		if ($jitsi_live_class->num_rows() > 0 && strtotime($jitsi_live_class_time) > time()):
...
<?php if($has_upcoming_live_class == 1): ?>
	<div class="alert alert-success text-center text-13px" role="alert">
		<?php echo get_phrase('Upcoming live class'); ?>
		<strong>
			<?php echo date('h:i A, d M Y', strtotime($live_class_time)); ?>
		</strong>
	</div>
<?php endif; ?>