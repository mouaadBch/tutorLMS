                        ...
                        <?php foreach ($this->session->userdata('cart_items') as $item) : ?>
                            ...
                            <tr>
                                ...
                                <td class="d-flex">
                                    ...
                                    $secondaryPayment = isCoursesSecondaryInSession($course_details['id']);

                                    if ($secondary_price && $secondary_price['secondary_price'] == 1 && $secondaryPayment == 1) {
                                ...
                                <td class="text-end">
                                    <a class="ms-auto" href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id'] . '?secondaryPayment=' . $secondaryPayment); ?>');"><i class="fa-solid fa-trash-can"></i></a>
                                </td>
                            </tr>
                        <?php endforeach; ?>
    ...
    <div class="col-lg-3 col-md-4">
        <div class="cart-total">
            ...
            <?php if (max_nbr_user()) : ?>
                ...
                <?php endif; ?>
            <?php else : ?>
                <button type="button" class="btn btn-secondary px-2 w-100" disabled><?php echo get_phrase('Continue to Payment') ?></button>
                <p class="text-danger text-center p-2 fw-bold fs-6">**You cannot register for those courses, <br> please contact your administrator to register</p>
            <?php endif; ?>
        </div>
    </div>
</div>
