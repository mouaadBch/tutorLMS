                                ...
                                <div class="col-12 course-heading-info mb-3">
                                    <div class="info-tag">
                                        ...
                                        <p class="text-15px mt-1">
                                            <a class="created-by-instructor" href="<?php echo site_url('home/instructor_page/' . $course_details['creator']); ?>"><?php echo substrFuction($instructor_details['last_name'], $instructor_details['first_name']) ?></a>
                                        </p>
                                    </div>
                    ...
                    <div class="course-card">
                        <div class="card-img">
                            <div class="courses-card-image">
                                <?php if (!empty($course_details['video_url'])) : ?>
                                    <div class="card-video-icon" onclick="lesson_preview('<?php echo site_url('home/course_preview/' . $course_details['id']); ?>', '<?php echo ($course_details['title']) ?>')">
                        ...
                        <div class="accordion" id="accordionPricing">
                                    ...
                                    <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne">
                                        ...
                                        <?php elseif ($course_details['discount_flag']) : ?>
                                            <div class="d-flex">
                                                ...
                                                <i class="fas fa-info-circle text-secondary" style="font-size: 10px;" data-bs-toggle="tooltip" data-bs-html="true" title="<?php echo get_phrase('Pay') . ' ' . currency($course_details['discounted_price']) . ' ' . get_phrase('instead of') . ' ' . currency($course_details['price']) . ' ' . get_phrase('a limited-time discount!') ?>"></i>
                                            </div>
                                        <?php else : ?>
                                            <div class="d-flex">
                                        ...
                                        <?php endif; ?>
                                        <h5> / <?php echo ($course_details['expiry_period'] == '') ? get_phrase('Lifetime') : $course_details['expiry_period'] . ' ' . get_phrase('months'); ?> </h5>
                                    </button>
                                </h2>
                                <div id="collapseOne" class="accordion-collapse collapse show" aria-labelledby="headingOne" data-bs-parent="#accordionPricing">
                                    <div class="accordion-body">
                                        <div class="button">
                                            ...
                                            <?php $secondaryPayment = isCoursesSecondaryInSession($course_details['id'])  ?>
                                            ...
                                            <?php else : ?>
                                                <?php if ($course_details['is_free_course'] == 1) : ?>
                                                    ...
                                                    <?php else : ?>
                                                        <button type="button" class="p-1 m-2 btn btn-secondary btn-md" disabled>
                                                            <?php echo get_phrase('Enroll Now'); ?>
                                                        </button>
                                                        <p class="text-danger text-center p-2">**You cannot register for this course, <br> please contact your administrator to register for this course</p>
                                                    <?php endif; ?>
                                                <?php else : ?>
                                                    <!-- Cart button -->
                                                    <?php if($secondaryPayment == 0 && in_array($course_details['id'], $cart_items)){ ?>
                                                            <a id="added_to_cart_btn_<?php echo $course_details['id']; ?>" class="active" href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id']).'?secondaryPayment=0'; ?>');"><i class="fas fa-minus"></i> <?php echo get_phrase('Remove from cart'); ?></a>
                                                        <?php }else{ ?>
                                                            <a id="add_to_cart_btn_<?php echo $course_details['id']; ?>"  href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id']).'?secondaryPayment=0'; ?>');"><i class="fas fa-plus"></i> <?php echo get_phrase('Add to cart'); ?></a>
                                                        <?php } ?>
                                                    <!-- Cart button ended  -->
                                                    <?php if (max_nbr_user()) : ?>
                                                        <a href="#" onclick="actionTo('<?php echo site_url('home/handle_buy_now/' . $course_details['id'].'?secondaryPayment=0'); ?>')"><i class="fas fa-credit-card"></i> <?php echo get_phrase('Buy Now'); ?></a>
                                                    <?php else : ?>
                                                        <button type="button" class="p-1 m-2 btn btn-secondary btn-md" disabled>
                            ...
                            <?php $secondary_price = string_to_json($course_details['secondary_price']) ;?>
                            <?php if ($secondary_price && $secondary_price['secondary_price'] && !$course_details['is_free_course']) : ?>
                                <div class="accordion-item">
                                    <h2 class="accordion-header" id="headingPriceTow">
                                        <button class="accordion-button" type="button" data-bs-toggle="collapse" data-bs-target="#collapsePriceTow" aria-expanded="true" aria-controls="collapsePriceTow">
                                            <?php if ($secondary_price['discount_flag']) : ?>
                                                <div class="d-flex">
                                                    <h1 class="fw-500"><?php echo currency($secondary_price['discounted_price']); ?></h1>
                                                    <i class="fas fa-info-circle text-secondary" style="font-size: 10px;" data-bs-toggle="tooltip" data-bs-html="true" title="<?php echo get_phrase('Pay') . ' ' . currency($course_details['discounted_price']) . ' ' . get_phrase('instead of') . ' ' . currency($course_details['price']) . ' ' . get_phrase('a limited-time discount!') ?>"></i>
                                                </div>
                                            <?php else : ?>
                                                <div class="d-flex">
                                                    <h1 class="fw-500"><?php echo currency($secondary_price['price']); ?></h1>
                                                </div>
                                            <?php endif; ?>
                                            <h5> / <?php echo ($secondary_price['expiry_period'] == '') ? get_phrase('Lifetime') : $secondary_price['expiry_period'] . ' ' . get_phrase('months'); ?> </h5>
                                        </button>
                                    </h2>
                                    <div id="collapsePriceTow" class="accordion-collapse collapse" aria-labelledby="headingPriceTow" data-bs-parent="#accordionPricing">
                                        <div class="accordion-body">
                                            <div class="button">
                                                <?php if (is_purchased($course_details['id'])) : ?>
                                                    <a href="<?php echo site_url('home/lesson/' . slugify($course_details['title']) . '/' . $course_details['id']) ?>"><i class="far fa-play-circle"></i> <?php echo get_phrase('Start Now'); ?></a>
                                                ...
                                                <?php else : ?>
                                                    ...
                                                    <?php else : ?>
                                                        <!-- Cart button -->
                                                        <?php if($secondaryPayment == 1 && in_array($course_details['id'], $cart_items)){ ?>
                                                            <a id="added_to_cart_btn_<?php echo $course_details['id']; ?>" class="active" href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id']).'?secondaryPayment=1'; ?>');"><i class="fas fa-minus"></i> <?php echo get_phrase('Remove from cart'); ?></a>
                                                        <?php }else{ ?>
                                                            <a id="add_to_cart_btn_<?php echo $course_details['id']; ?>"  href="#" onclick="actionTo('<?php echo site_url('home/handle_cart_items/' . $course_details['id']).'?secondaryPayment=1'; ?>');"><i class="fas fa-plus"></i> <?php echo get_phrase('Add to cart'); ?></a>
                                                        <?php } ?>

                                                        <!-- Cart button ended  -->
                                                        <?php if (max_nbr_user()) : ?>
                                                            <a href="#" onclick="actionTo('<?php echo site_url('home/handle_buy_now/' . $course_details['id'].'?secondaryPayment=1'); ?>')"><i class="fas fa-credit-card"></i> <?php echo get_phrase('Buy Now'); ?></a>
                                                        <?php else : ?>
                                                            <button type="button" class="p-1 m-2 btn btn-secondary btn-md" disabled>
                                                                <?php echo get_phrase('Buy Now'); ?>
                                                            </button>
...
<textarea class="w-100" rows="10" cols="20"><?php print_r (($this->session->userdata())) ?></textarea>
