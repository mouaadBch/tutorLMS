              ...
              <?php
                ...
                <div class="col-lg-4">
                  <a href="#" class="course-item-one">
                    ...
                    <div class="content">
                      <h4 class="title"><?php echo ellipsis($upcoming_course['title']); ?></h4>
                    ...
                    <div class="col-lg-2 col-md-3 col-sm-3 col-4 mb-3">
                        <div class="h-2-top-body" onclick="redirectTo('<?php echo site_url('home/courses?category='.$category_details['slug']); ?>')">
                            <div class="h-2-top" style="width: 150px !important;height: 150px !important;">
                                <a href="<?php echo site_url('home/courses?category='.$category_details['slug']); ?>" style="margin: 0;color: #<?php echo rand(100000, 999999); ?>">
                                    <?php if ($category_details['thumbnail'] != null) {?>
                                        <img style="width: 130px !important;height: 130px !important;" src="<?php echo base_url('uploads/thumbnails/category_thumbnails/' . $category_details['thumbnail']); ?>" alt="<?php echo $category_details['name']; ?>">
                                    <?php }else { ?>
                                         <i style="font-size: 50px;" class="<?php echo $category_details['font_awesome_class']; ?>"></i>
                                    <?php  } ?>
                                </a>
                             </div>
                    ...
                    <div class="single-popup-course">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($top_course['title'])) . '/' . $top_course['id']); ?>" id="top_course_<?php echo $top_course['id']; ?>" class="checkPropagation courses-card-body">
                            ...
                            <div class="courses-text">
                                <h5 class="mb-2"><?php echo ellipsis($top_course['title']); ?></h5>
                ...
                foreach ($latest_courses as $latest_course) :
                    ...
                    <div class="single-popup-course">
                        <a href="<?php echo site_url('home/course/' . rawurlencode(slugify($latest_course['title'])) . '/' . $latest_course['id']); ?>" id="latest_course_<?php echo $latest_course['id']; ?>" class="checkPropagation courses-card-body">
                            ...
                            <div class="courses-text">
                                <h5 class="mb-2"><?php echo ellipsis($latest_course['title']); ?></h5>
                                <div class="review-icon">
                                    <div class="review-icon-star align-items-center">
                                        <p><?php echo $average_ceil_rating; ?></p>
                                        <p><i class="fa-solid fa-star <?php if($number_of_ratings > 0) echo 'filled'; ?>"></i></p>
                        ...
                        <div class="col-lg-3 col-md-4 col-sm-6">
                            <div class="h-2-instructor-full">
                                ...
                                <div class="h-2-instructor-text">
                                    <a class="text-muted px-3 mb-3" href="<?php echo site_url('home/instructor_page/'.$top_instructor['id']); ?>">
                                        <h3><?php echo substrFuction($top_instructor['last_name'],$top_instructor['first_name']); ?></h3>
                                        <!-- <p class="ellipsis-line-2 "><?php #echo ellipsis($top_instructor['title']); ?></p> -->
                                    </a>
                                </div>
                            </div>
                        </div>
...
<section class="expert-instructor top-categories pb-3">
  <div class="container">
    ...
    <ul class="speech-items">
        <?php  $i=0; foreach($motivational_speechs[$this->session->userdata('language')] as $key => $motivational_speech): ?>
