...
<div class="menu_pro_wish" style="width: 275px;">
    ...
    <div class="menu_pro_btn">
        <!-- <a href="#" onclick="actionTo('<?php #echo site_url('home/get_my_notification/mark_all_as_read'); ?>');" class="btn btn-primary text-white">
            <?php #echo get_phrase('Mark all as read'); ?>
        </a> -->
        <a href="<?php echo site_url("/home/my_notifications")?>" class="btn btn-primary text-white">
            <?php echo "View all notifications"; /* get_phrase(''); */ ?>
        </a>
    </div>
</div>