                    ...
                    <div class="row">
                        <?php foreach($enrolments as $enrolment):
                            ...
                            <div class="col-lg-12 col-md-12 col-sm-6 col-12 mb-5">
                                <div class="my-course-1-full-body-card" style="cursor: auto !important;">
                                        ...
                                        <div class="my-course-1-last">
                                            <div class="icon-img d-grid">
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <span class="text-14px ms-1 mt-1"><?php echo substrFuction($instructor_details['last_name'],$instructor_details['first_name']); ?> </span>
                                                    <div class="star m-0">
                                                        <?php for($i = 1; $i <= 5; $i++): ?>
