<?php 
$number_of_unread_notification = $this->db->order_by('status ASC, id desc')->where('status', 0)->where('to_user', $this->session->userdata('user_id'))->get('notifications')->num_rows();
?>
<nav class="navbar navbar-expand-lg navbar-light">
  <div class="container">
    ...
    <div class="navbar-collapse" id="navbarSupportedContent">
              ...
              <li class="dropdown-submenu">
                ...
                <ul class="sub-category-menu">
                  ...
                  foreach ($sub_categories as $sub_category): ?>
                    <li><a href="<?php echo site_url('home/courses?category='.slugify($sub_category['slug'])) ?>"><?php echo site_phrase($sub_category['name']); ?></a></li>
                  <?php endforeach; ?>
                </ul>
              </li>
            <?php endforeach; ?>
              ...
              #foreach ($ebook_categories as $key => $ebook_category):?>
                <li class="dropdown-submenu">
                  <a href="<?php #echo site_url('ebook?category='.$ebook_category['slug'].'&price=all&rating=all') ?>">
                    <span class="text-cat"><?php #echo get_phrase($ebook_category['title']); ?></span>
                  </a>
                </li>
              <?#php endforeach; ?>
            </ul>
      ...
      <!-- <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0 ms-2" >
          <li class="nav-item">
            <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap" style="border-radius: 20px;background-image: url('https://monconcours.ma/images/giphy.gif');background-size: cover;" href="<?php echo site_url('course_bundles'); ?>" id="navbarDropdown8">
              <span class="ms-2 text-danger fs-6 fw-bolder bg-white px-1 rounded"><?php #echo site_phrase('Course Bundle'); ?></span>
            </a>
          </li>
      </ul> -->
        ...
        <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0 ms-2">
          <li class="nav-item">
            <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap" href="<?php
                                          if ($this->session->userdata('language') == 'fr' || $this->session->userdata('language') == 'french') {
        ...
        <ul class="navbar-nav main-nav-wrap mb-2 mb-lg-0 ms-2">
          <li class="nav-item">
            <a class="nav-link header-dropdown bg-white text-dark fw-600 text-nowrap" href="<?= site_url('user') ?>" id="navbarDropdown4">
              <span class="ms-2"><?php echo site_phrase('Instructor Dashboard'); ?></span>
            </a>
          </li>
        </ul>
      <?php endif; ?>
