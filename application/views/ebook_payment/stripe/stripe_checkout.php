...
define('STRIPE_SUCCESS_URL', site_url('addons/ebook/stripe_payment/'.$user_details['id'].'/'.$ebook_id));
define('STRIPE_CANCEL_URL', site_url('addons/ebook/buy/'.$ebook_id));
    ...
    try {
        $session = \Stripe\Checkout\Session::create([
            ...
            'line_items' => [[
                'price_data' => [
                    'product_data' => [
                        'name' => get_phrase("pay_for").' '.get_phrase('1').' '.get_phrase("ebook")
                    ],
