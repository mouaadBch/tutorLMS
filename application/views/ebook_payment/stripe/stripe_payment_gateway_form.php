...
<div id="buynow" style="height: 45px;">
    <button class="stripe-button payment-button float-end"
        id="stripePayButton"><?php echo get_phrase("pay_with_stripe"); ?>
    </button>
</div>
...
var createCheckoutSession = function(stripe) {
    return fetch("<?= site_url('addons/ebook/stripe_checkout/'.$ebook_details['ebook_id']); ?>", {
        method: "POST",
        headers: {
