    ...
    <div class="col-xl-12">
        <div class="card">
            ...
            <ul class="nav nav-tabs nav-bordered mb-3">
                ...
                <!-- <h4 class="mb-3 header-title"><?php //echo get_phrase('Affiliator List'); ?></h4> -->
                <div class="table-responsive-sm mt-4">
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php
                            foreach ($suspend_affiliator->result_array() as $key => $user) :
                                $CI    = &get_instance();
                                ...
                                <tr>
                                    ...
                                    <td><?php echo $user_name['first_name'] . ' ' . $user_name['last_name']; ?>
                                        <?php if ($user['status'] == 2) : ?>
                                            <small>
                                                <p><?php echo get_phrase('status'); ?>: <span class="badge badge-warning"><?php echo get_phrase('suspend'); ?></span></p>
                                            </small>
                                        <?php endif; ?>
                                    </td>
                                    ...
                                    <td>
                                                <?php if (!empty($user['document'])) : ?>
                                                    <a  href="<?php echo site_url( "addons/affiliate_course/suspend_affiliator/download/".$user['user_id']); ?>" class="btn btn-info" download>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/affiliate_course/suspend_affiliator/active/' . $user['user_id']); ?>');"><?php echo get_phrase('active'); ?></a></li>
                                               
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/affiliate_course/suspend_affiliator/delete/' . $user['user_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
