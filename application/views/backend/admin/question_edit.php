...
<form class="pb-5" action="<?php echo site_url('admin/quiz_questions/'.$question_details['quiz_id'].'/edit/'.$param2); ?>" method="post" id = 'mcq_form'>
    ...
    <div class="form-group">
        <label for="justify_id"><?php echo get_phrase('justif'); ?></label>
        <textarea name="justify" id="justify_id" class="form-control"><?php echo $question_details['justify']; ?></textarea>
    </div>
...
$(function(){
    /* code mouaad */
    initSummerNote(['#question_title','#justify_id','.optionMouaad']);
    $('.select2').select2();
});
</script> 
