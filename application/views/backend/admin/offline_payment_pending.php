                    ...
                    <tbody>
                        ...
                        foreach ($offline_payments as $key => $offline_payment): ?>
                          <tr>
                              ...
                              <td>
                                  ...
                                  if ($offline_payment['item_type'] == 'ebook') :
                                    foreach (json_decode($offline_payment['course_id']) as $course_id) :
                                      ...
                                      <a href="<?php echo site_url('addons/ebook_manager/edit_ebook/' . $course_id); ?>" target="_blank" >
                                  ...
                                  elseif ($offline_payment['item_type'] == 'bundle') :
                                    foreach (json_decode($offline_payment['course_id']) as $course_id) :
                                      ...
                                      <a href="<?php echo site_url('addons/bundle/edit_bundle_form/' . $course_id); ?>" target="_blank" >
                                        <i class="mdi mdi-arrow-right"></i>
                                        <?php echo $course_title; ?>
                                      </a>
                                      <br>
                                  ...
                                  elseif ($offline_payment['item_type'] == 'booking') :
                                    ...
                                    foreach (json_decode($offline_payment['course_id']) as $course_id) :
                                      ...
                                      <a href="<?php echo site_url('admin/course_form/course_edit/' . $course_id); ?>" target="_blank" >
                                        <i class="mdi mdi-arrow-right"></i>
                                        <?php echo $course_title; ?>
                                      </a>
                                      <br>
                              ...
                              <td>
                                <a href="<?php echo base_url('uploads/payment_document/'.$offline_payment['document_image']); ?>" class="btn btn-outline-info" download>
                                  <i class="mdi mdi-download"></i><?php #echo get_phrase('payment_document_file'); ?>
                                </a>
                              </td>
                              <td>
