                            ...
                            <table id="pending-payout" class="table table-striped table-centered mb-0">
                                ...
                                <tbody>
                                    <?php foreach ($pending_course_payouts->result_array() as $key => $pending_payout) :
                                        ...
                                        $paypal_keys = $payment_keys['paypal'] ?? null;
                                        $stripe_keys = $payment_keys['stripe'] ?? null;
                                        $razorpay_keys = $payment_keys['razorpay'] ?? null;
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td style="text-align: center;">
                                                ...
                                                if ($pending_payout['status'] == "pending") : ?>
                                                    ...
                                                    <a class="btn btn-success" onclick="confirm_modal('<?php echo site_url('addons/affiliate_course/configure_affiliator_payment/'. $pending_payout['id'].'/force') ?>');"> <i class="mdi mdi-credit-card"></i> <?php echo get_phrase('force pay'); ?></a>
                                                <?php else : ?>
