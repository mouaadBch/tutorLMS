                                ...
                                <div class="row">
                                    <div class="col-12">
                                        ...
                                        <!-- <div class="<?php #if($payment_gateway['status'] != 1 || !addon_status($payment_gateway['identifier']) && $payment_gateway['is_addon'] == 1) echo 'd-none'; 
                                                            ?>">
                                                <h4><?php #echo get_phrase($payment_gateway['title']); 
                                                    ?></h4>
                                                ...
                                                ?>
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        <label class="col-md-3 col-form-label" for="<?php #echo $payment_gateway['identifier'].$index; 
                                                                                                    ?>"> <?php #echo get_phrase($index); 
                                                                                                            ?></label>
                                                        <div class="col-md-9">
                                                            <input type="text" id="<?php #echo $payment_gateway['identifier'].$index; 
                                                                                    ?>" name="gateways[<?php #echo $payment_gateway['identifier']; 
                                                                                                        ?>][<?php #echo $index; 
                                                                                                            ?>]" value="<?php #echo $value; 
                                                                                                                                                                            ?>" class="form-control">
                                                            <small><?php #echo get_phrase("required_for_instructor"); 
                                                                    ?></small>
                                                        </div>
                                                    </div>
                                                <?php #endforeach; 
                                    ...
                                    <div class="col-12">
                                        <div class="card border-secondary border-2">
                                            <div class="card-body">
                                                <h4 class="card-title"><?php echo get_phrase('instructor_revenue'); ?></h4>
                                                <div class="p-1">
                                                    <div class="card-text border border-primary border-3 opacity-75 p-1 mb-2">
                                                        <h3 class="text-center">Coures</h3>
                                                        <div class="form-group">
                                                            <label for="instructor_revenue_coures"><?php echo get_phrase('instructor_revenue_percentage'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" name="instructor_revenue_coures" id="instructor_revenue_coures" class="form-control" onchange="calculateAdminRevenue(this.value,'revenue_coures')" min="0" max="100" value="<?php echo $user_data['percentage_rev_cours'] ?? get_settings('instructor_revenue'); ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <p class="m-0"><?php echo get_phrase('admin_revenue_percentage'); ?> : <span id="admin_revenue_coures"></span>%</p>
                                                    </div>
                                                    <div class="card-text border border-primary border-3 opacity-75 p-1 mb-2">
                                                        <h3 class="text-center">Ebook</h3>
                                                        <div class="form-group">
                                                            <label for="instructor_revenue_ebook"><?php echo get_phrase('instructor_revenue_percentage'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" name="instructor_revenue_ebook" id="instructor_revenue_ebook" class="form-control" onchange="calculateAdminRevenue(this.value,'revenue_ebook')" min="0" max="100" value="<?php echo $user_data['percentage_rev_ebook'] ?? get_settings('instructor_revenue'); ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <p class="m-0"><?php echo get_phrase('admin_revenue_percentage'); ?> : <span id="admin_revenue_ebook"></span>%</p>
                                                    </div>
                                                    <div class="card-text border border-primary border-3 opacity-75 p-1 mb-2">
                                                        <h3 class="text-center">Tutoring</h3>
                                                        <div class="form-group">
                                                            <label for="instructor_revenue_titoring"><?php echo get_phrase('instructor_revenue_percentage'); ?></label>
                                                            <div class="input-group">
                                                                <input type="number" name="instructor_revenue_titoring" id="instructor_revenue_titoring" class="form-control" onchange="calculateAdminRevenue(this.value,'revenue_titoring')" min="0" max="100" value="<?php echo $user_data['percentage_rev_tutor'] ?? get_settings('instructor_revenue'); ?>">
                                                                <div class="input-group-append">
                                                                    <span class="input-group-text"><i class="mdi mdi-percent"></i></span>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <p class="m-0"><?php echo get_phrase('admin_revenue_percentage'); ?> : <span id="admin_revenue_titoring"></span>%</p>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function() {
        var instructor_revenue_coures = $('#instructor_revenue_coures').val();
        var instructor_revenue_ebook = $('#instructor_revenue_ebook').val();
        var instructor_revenue_titoring = $('#instructor_revenue_titoring').val();
        calculateAdminRevenue(instructor_revenue_coures, 'revenue_coures');
        calculateAdminRevenue(instructor_revenue_ebook, 'revenue_ebook');
        calculateAdminRevenue(instructor_revenue_titoring, 'revenue_titoring');
    });

    function calculateAdminRevenue(instructor_revenue, type) {
        if (instructor_revenue <= 100 && instructor_revenue >= 0) {
            var admin_revenue = 100 - instructor_revenue;
            $('#admin_' + type).text(admin_revenue);
        } else {
            $('#instructor_' + type).val(70);
            $('#admin_' + type).text(0);
        }
    }
</script>