    ...
    <div class="col-xl-12">
        <div class="card">
            <div class="card-body">
                ...
                <h4 class="header-title mb-3"><?php echo get_phrase('affiliator_add_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('addons/affiliate_course/affiliator_form/add'); ?>" enctype="multipart/form-data" method="post">
                        ...
                        <div class="tab-content b-0 mb-0">
                            ...
                            <div class="tab-pane" id="login_credentials">
                                <div class="row">
                                    <div class="col-12">
                                        <div class="form-group row mb-3">
                                            <label class="col-md-3 col-form-label" for="email"><?php echo get_phrase('email'); ?><span class="required">* <span id="exist" class=text-success>  </span> <span id="not_exist" class=text-success>  </span></span></label>
                                            <div class="col-md-9">
...
</div> <span id="exist" class=text-success>  </span> <span id="not_exist" class=text-success>  </span>
...
$(document).ready(function(){ 
 ...
 $.ajax({
     url:"<?php echo base_url(); ?>addons/affiliate_course/check_affiliator_email_exists",
     method: "GET",
       ...
       let data=JSON.parse(response);
         if(data.status)
         {
           if($a==0)
           {
            ...
            $("#not_exist").html("");
            $("#exist").html(" : User exits in database ");
