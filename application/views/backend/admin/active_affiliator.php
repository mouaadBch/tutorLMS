            ...
            <ul class="nav nav-tabs nav-bordered mb-3">
                ...
                <div class="table-responsive-sm mt-4">
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        ...
                        <tbody>
                            <?php
                            foreach ($active_affiliator->result_array() as $key => $user) :
                                $CI    = &get_instance();
                                ...
                                <tr>
                                    ...
                                    <td>
                                                <?php if (!empty($user['document'])) : ?>
                                                    <a  href="<?php echo site_url( "addons/affiliate_course/active_affiliator/download/".$user['user_id']); ?>" class="btn btn-info" download>
                                    ...
                                    <td>
                                        <div class="dropright dropright">
                                            ...
                                            <ul class="dropdown-menu">
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/affiliate_course/active_affiliator/suspended/' . $user['user_id']); ?>');"><?php echo get_phrase('suspend'); ?></a></li>
                                               
                                                <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/affiliate_course/active_affiliator/delete/' . $user['user_id']); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                                            </ul>
                                        </div>
                                    </td>
                                </tr>
