<?php
$category_details = $this->tutor_booking_model->get_tutor_category_details_by_id($category_id)->row_array();
?>
...
<div class="row">
  <div class="col-12">
    <div class="page-title-box ">
      <h4 class="page-title"> <i class="mdi mdi-apple-keyboard-command title_icon"></i> <?php echo get_phrase('update_tutor_category'); ?></h4>
    </div>
  </div>
</div>
...
<div class="row justify-content-md-center">
  <div class="col-xl-6">
    <div class="card">
      <div class="card-body">
        <div class="col-lg-12">
          <h4 class="mb-3 header-title"><?php echo get_phrase('update_tutor_category_form'); ?></h4>

          <form class="required-form" action="<?php echo site_url('addons/tutor_booking/tutor_categories/edit/'.$category_id); ?>" method="post" enctype="multipart/form-data">
