<div class="tab-content">
  <div class="tab-pane <?php if($status == 'closed') echo 'show active'; ?>" id="closed">
                    ...
                    <td>
                        <div class="dropright dropright">
                          ...
                          <ul class="dropdown-menu">
                              ...
                              <li><a class="dropdown-item" href="#" onclick="confirm_modal('<?php echo site_url('addons/customer_support/delete_ticket/'.$ticket['id'].'/closed'); ?>');"><?php echo get_phrase('delete'); ?></a></li>
                          </ul>
                      </div>
                    </td>
                  </tr>
