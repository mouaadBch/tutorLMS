                                ...
                                <tbody>
                                    ...
                                    ?>
                                        <tr class="gradeU">
                                            ...
                                            <td style="text-align: center;">
                                                <a class="btn btn-danger" onclick="confirm_modal('<?php echo site_url('admin/instructor_payment/' . $pending_payout['user_id'].'/offline'); ?>');" href="#">
                                                    <i class="mdi mdi-credit-card"></i>
                                                    <?php echo get_phrase('pay_offline'); ?>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
