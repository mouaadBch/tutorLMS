...
<div class="mt-3">
    ...
    <div class="custom-control custom-radio">
        <input type="radio" id="bunny" name="lesson_type" class="custom-control-input" value="bunny" <?php if ($selected_lesson == 'bunny') echo 'checked'; ?>>
        <label class="custom-control-label" for="bunny">bunny video</label>
    </div>
