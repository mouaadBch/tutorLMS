                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        ...
                                                        <span class="text-primary">*<?= site_phrase('affiliate_text_info') ?></span>
                                                    </div>
                                                </div>
                                                <div class="form-group row mb-3">
                                                    <label class="col-md-2 col-form-label" for="course_order"><?= site_phrase('course_order') ?></label>
                                                    <div class="col-md-10">
                                                        <input type="number" step="1" class="form-control" id="course_order" name="course_order" value="<?php echo $course_details['orderBy']; ?>">
                                                    </div>
                                                </div>
                                                <!-- /code mouaad -->
                                            </div> <!-- end col -->
