                                    ...
                                    <?php foreach ($pending_applications->result_array() as $key => $pending_application) :
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td class="text-center">
                                                <b><?= date("d M Y H:i",$pending_application['created_at']) ?></b>
                                ...
                                <tbody>
                                    <?php foreach ($approved_applications->result_array() as $key => $approved_application) :
                                        ...
                                        <tr class="gradeU">
                                            ...
                                            <td class="text-center">
                                                <b><?= date("d M Y H:i",$approved_application['created_at']) ?></b>
                                            ...
                                            <td style="text-align: center;">
                                                <a title="mark comme en attente" class="dropdown-item " href="#" onclick="confirm_modal('<?php echo site_url(); ?>admin/instructor_application/waiting/<?php echo $approved_application['id']; ?>');">
                                                    <i class="fas fa-pause-circle btn btn-sm btn-primary"></i>
                                                </a>
                                            </td>
                                        </tr>
                                    <?php endforeach; ?>
