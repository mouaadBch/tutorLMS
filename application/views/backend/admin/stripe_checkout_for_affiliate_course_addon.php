...
define('STRIPE_SUCCESS_URL', site_url('addons/affiliate_course/stripe_payment/'.$payout_id));
define('STRIPE_CANCEL_URL', site_url('addons/affiliate_course/affiliation_course_payouts'));
