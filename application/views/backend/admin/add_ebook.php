                                                    ...
                                                    <div class="form-group mb-3">
                                                        ...
                                                        <div class="wrapper-image-preview" style="margin-left: -6px;">
                                                            <div class="box" style="width: 300px;">
                                                                <div class="js--image-preview" style="background-image: url('<?php echo base_url('uploads/ebook/banner/placeholder.png') ?>'); background-color: #F5F5F5; background-size: cover; background-position: center;">
                                                                </div>
...
<?php else : ?>
    <div class="card">
        <h3 class="text-center">
            you have reached the user limit, please upgrade your subscription
            <br>
            <span class="btn btn-danger">upgrade now</span>
        </h3>
    </div>
<?php endif; ?>