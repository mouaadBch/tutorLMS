<form class="pb-5" action="<?php echo site_url('admin/quiz_questions/'.$param2.'/add'); ?>" method="post" id = 'mcq_form'>
    ...
    <!-- code Mouaad -->
    <div class="form-group">
        <label for="justify_id">Justification</label>
        <textarea name="justify" id="justify_id" class="form-control"></textarea>
    </div>
    <!-- / code Mouaad -->
...
$(function(){
    // code Mouaad  justify_id
    initSummerNote(['#question_title','#justify_id']);
    $('.select2').select2();
});
</script>
