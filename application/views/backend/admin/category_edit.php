        ...
        <div class="col-lg-12">
          ...
          <form class="required-form" action="<?php echo site_url('admin/categories/edit/' . $category_id); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="form-group" id="thumbnail-picker-area">
              <label><?php echo get_phrase('category_thumbnail'); ?> <small>(<?php echo get_phrase('the_image_size_should_be'); ?>: 400 X 400)</small> </label>
            ...
            <?php
            if ($category_details['thumbnail'] != null) {?>
                <img class="w-100 mb-2" src="<?php echo site_url('uploads/thumbnails/category_thumbnails/' . $category_details['thumbnail'])?>">
            <?php } ?>
