...
<div class="input-group mb-3">
    <input id="video_link_for_bunny" type="url" class="form-control" placeholder="URL" name="video_link_for_bunny">
</div>

<div class="form-group">
    <label><?php echo get_phrase('duration'); ?>( <?php echo get_phrase('for_web_and_mobile_application'); ?> )</label>
    <input type="text" class="form-control" data-toggle='timepicker' data-minute-step="5" name="bunny_duration" id="bunny_duration" data-show-meridian="false" value="00:00:00" required>
</div>