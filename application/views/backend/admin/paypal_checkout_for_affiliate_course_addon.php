...
<body>
    ...
    <div class="package-details">
        <strong><?php echo get_phrase('Name');?> | <?php echo $instructor_name;?></strong> <br>
    ...
    paypal.Button.render({
        ...
        onAuthorize: function(data, actions) {
            ...
            return actions.payment.execute().then(function() {
                var redirectUrl = '<?php echo site_url('addons/affiliate_course/paypal_payment/'.$payout_id);?>'+'/'+data.paymentID+'/'+data.paymentToken+'/'+data.payerID+'/';
