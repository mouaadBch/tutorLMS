                    ...
                    <table id="basic-datatable" class="table table-striped table-centered mb-0">
                        <thead>
                            <tr>
                                ...
                                <!-- <th><?php #echo get_phrase('Category'); 
                                            ?></th> -->
                                <!-- <th><?php #echo get_phrase('Class Type'); 
                                            ?></th> -->
                                <th><?php echo get_phrase('price_type'); ?></th>
                                <th><?php echo get_phrase('instructor_revenue'); ?></th>
                                <!-- <th><?php #echo get_phrase('tutor'); 
                                            ?></th>
                                <th><?php #echo get_phrase('Tution type'); 
                                    ?></th>
                                <th><?php #echo get_phrase('Selected days'); 
                                    ?></th> -->
                                <!-- <th><?php #echo get_phrase('Start Class '); 
                                            ?></th> -->
                            </tr>
                        </thead>
                        <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <!-- <td>
                                            ...
                                            if ($booking['sub_category_id'] != 0) :
                                                $sub_category_name = $this->db->get_where('tutor_category', array('id' => $booking['sub_category_id']))->row_array();  */ ?>
                                                <small>
                                                    <p><span><?php #echo get_phrase($sub_category_name['name']); 
                                                                ?></span></p>
                                                </small>
                                            <?php #else :  
                                            ?>
                                                <small>
                                                    <p><span><?php #echo get_phrase('no sub_category') 
                                                                ?></span></p>
                                                </small>
                                            <?php #endif;  
                                            ?>
                                        ...
                                        <td>
                                            <?php
                                            echo get_phrase('Class Type') . ': ' . get_phrase($c_type) . '<br/>';
                                            echo get_phrase('price') . ': ' . currency($booking['price']) . '<br/>';
                                            echo get_phrase('price_type') . ': ' . get_phrase($booking['price_type']) . '<br/>';
                                            ?>
                                        </td>
                                        ...
                                        <td>
                                            ...
                                            echo get_phrase('total_amount') . ': <span class="badge">' . currency($tutor_payment['amount']) . '</span><br>';
                                            echo get_phrase('instructor_revenue') . ': <span class="badge bg-success text-white">' . currency($tutor_payment['instructor_revenue']) . '</span><br>';
