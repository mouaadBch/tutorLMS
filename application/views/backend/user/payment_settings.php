        ...
        <div class="card-body">
          ...
          <form class="" action="<?php echo site_url('user/payout_settings/paypal_settings'); ?>" method="post" enctype="multipart/form-data">
            ...
            <?php $payment_gateways = $this->db->get('payment_gateways')->result_array();
                ...
                ?>
                <div class="<?php if($payment_gateway['status'] != 1 || !addon_status($payment_gateway['identifier']) && $payment_gateway['is_addon'] == 1 || $payment_gateway['identifier'] == 'offline_payment' || $payment_gateway['identifier'] == 'cmi') echo 'd-none'; ?>">
