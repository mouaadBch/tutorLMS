...
<lable for="video_link_for_amazon_s3" ><?php echo get_phrase('video_link_for_amazon_s3'); ?></lable>
<div class="input-group mb-3">
  <input id="video_link_for_amazon_s3" type="url" class="form-control"  placeholder="URL" name="video_link_for_amazon_s3" value="<?=  $lesson_details['video_url']; ?>" >
</div>
