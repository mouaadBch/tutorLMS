                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="select2 form-control select2-multiple" data-toggle="select2" multiple="multiple" data-placeholder="Choose ..." name="new_instructors[]">
                                                            ...
                                                            <?php foreach ($instructors as $key => $instructor) : ?>
                                                                <option value="<?php echo html_escape($instructor['id']); ?>">
                                                                <?php echo html_escape(strtoupper(substr($instructor['last_name'], 0, 1)) . ' . ' .$instructor['first_name']   . '. [ id =' . $instructor['id'] . "]"); ?>
                                                                </option>
                                                            <?php endforeach; ?>
                                                        </select>
                                                    </div>
                                                    ...
                                                    <div class="col-md-10">
                                                        <select class="form-control select2" data-toggle="select2" name="sub_category_id" id="sub_category_id" required>
                                                            ...
                                                            <?php foreach ($categories->result_array() as $category) : ?>
                                                                <optgroup label="<?php echo get_phrase($category['name']); ?>">
                                                                    <?php $sub_categories = $this->crud_model->get_sub_categories($category['id']);
                                                                    foreach ($sub_categories as $sub_category) : ?>
                                                                        <option value="<?php echo $sub_category['id']; ?>" <?php if ($sub_category['id'] == $course_details['sub_category_id']) echo 'selected'; ?>>
                                                                            <?php echo  get_phrase($sub_category['name']); ?>
                                                                        </option>
                                                                    <?php endforeach; ?>
                                                                </optgroup>
                                                            <?php endforeach; ?>
                                                ...
                                                <div class="form-group row mb-3">
                                                    <div class="offset-md-2 col-md-10">
                                                        <div class="custom-control custom-checkbox">
                                                            <input type="checkbox" class="custom-control-input" name="is_affiliate" id="is_affiliate" value="1" <?php if ($course_details['is_affiliate'] == 1) echo 'checked'; ?>>
                                                            <label class="custom-control-label" for="is_affiliate"><?php echo get_phrase('check_if_this_course_is_affiliate'); ?></label>
                                                        </div>
                                                        <span class="text-primary">*<?= site_phrase('affiliate_text_info').' '. get_settings('affiliate_addon_percentage') ?>% </span>
                                                    </div>
                                                </div>
                                                <!-- /code mouaad -->
                                            </div> <!-- end col -->
                                            ...
                                            <div class="col-xl-8">
                                                ...
                                                <div class="paid-course-stuffs">
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" class="form-control" onkeyup="calculateProfPercentage()" id="price" name="price" min="100" placeholder="<?php echo get_phrase('enter_course_course_price'); ?>" value="<?php echo $course_details['price']; ?>">
                                                    ...
                                                    <div class="form-group row mb-3">
                                                        ...
                                                        <div class="col-md-8">
                                                            <input type="number" class="form-control" name="discounted_price" id="discounted_price" onkeyup="calculateDiscountPercentage(this.value)" value="<?php echo $course_details['discounted_price']; ?>" min="100">
...
<script type="text/javascript">
    ...
    checkbox.addEventListener('change', (event) => {
        if (event.currentTarget.checked) {
            jQuery('#prof_one').hide();
            jQuery('#prof_tow').show();
        } else {
            jQuery('#prof_one').show();
            jQuery('#prof_tow').hide();
        }
    })
