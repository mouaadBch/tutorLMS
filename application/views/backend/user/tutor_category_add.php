...
<div class="row justify-content-center">
    <div class="col-xl-7">
        <div class="card">
            <div class="card-body">
              <div class="col-lg-12">
                <h4 class="mb-3 header-title"><?php echo get_phrase('tutor_category_add_form'); ?></h4>

                <form class="required-form" action="<?php echo site_url('addons/tutor_booking/tutor_categories/add'); ?>" method="post" enctype="multipart/form-data">
