...
function websdkready() {
  ...
  var CLIENT_ID = "b9soC50RRrugUVTySUgx4w";//7M6Wg3sxRP6fRudLqqskYQ
  /**
   ...
   */
  var CLIENT_SECRET = "hoOTsEeHHbJ3U2Ch5Tqd5fhMJ5OgKzdk";//4AnRnAOG0rf7LlUxaZD4tGiTjE7woTG5
  ...
  document.getElementById("clear_all").addEventListener("click", function (e) {
    ...
    window.location.href = "/test/zoom-we-sdk/meetingsdk-web-sample-master/zoom-web-sdk-cdn/index.html";
  });
    ...
    .addEventListener("click", function (e) {
      ...
      var signature = ZoomMtg.generateSDKSignature({
        ...
        success: function (res) {
          ...
          var joinUrl = "/test/zoom-we-sdk/meetingsdk-web-sample-master/zoom-web-sdk-cdn/meeting.html?" + testTool.serialize(meetingConfig);
          console.log(joinUrl);
    ...
    var signature = ZoomMtg.generateSDKSignature({
      ...
      success: function (res) {
        ...
        var joinUrl =
          ...
          "/test/zoom-we-sdk/meetingsdk-web-sample-master/zoom-web-sdk-cdn/meeting.html?" +
